            ...
            <ul class="pb-4 flex flex-col justify-start space-y-4">
                ...
                <li>
                    <a href="{{ route('profile.sessions') }}" class="flex items-center flex-row gap-2">
                        <span>
                            <svg width="24" height="24" class="[&>path]:fill-white w-6 h-6" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <li>
                    <a href="{{ route('profile.favorites') }}" class="flex items-center flex-row gap-2">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="[&>path]:fill-white w-6 h-6"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
