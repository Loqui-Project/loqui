    ...
    <div x-show="open" @click.outside="open = false" x-transition class="absolute top-[76px] w-full bg-white dark:bg-black rounded-md shadow-lg  p-4">
        <nav class="border-b border-b-black  dark:border-b-white">
            <ul class="pb-4 flex flex-col justify-start space-y-4">
                <li>
                    <a wire:navigate href="{{ route('profile.account') }}" class="flex items-center flex-row gap-2">
                        <span>
                ...
                <li>
                    <a wire:navigate href="{{ route('profile.sessions') }}" class="flex items-center flex-row gap-2">
                        <span>
                            <svg width="24" height="24" class="[&>path]:fill-white w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a wire:navigate href="{{ route('profile.favorites') }}" class="flex items-center flex-row gap-2">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="[&>path]:fill-white w-6 h-6" xmlns="http://www.w3.org/2000/svg">
