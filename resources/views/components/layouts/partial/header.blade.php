<header
    class="sticky inset-x-0 top-2 z-50 m-6 shadow-surface-glass backdrop-blur will-change-transform [@supports(backdrop-filter:blur(15px))]:bg-secondary-main/[3%] shadow-sm rounded-md bg-white/30 dark:bg-brand-dark/30">
    <div class="container">
        <nav class="flex items-center justify-between laptop:px-8 " aria-label="Global">
            ...
            @else
                <div class="hidden laptop:flex laptop:gap-x-6 p-4">
                    ...
                    <a href={{ route('auth.sign-out') }}
                        class="text-sm bg-brand-dark px-8 py-2 rounded-md hover:bg-brand-dark/90 transition-all duration-300 font-semibold leading-6 flex gap-4 items-center text-gray-900 dark:text-white">
                        <span>
                            Sign up
                        </span>
                    </a>
