<header class="sticky inset-x-0 top-0 z-50 border-t-2 border-t-brand-dark shadow-surface-glass backdrop-blur will-change-transform [@supports(backdrop-filter:blur(15px))]:bg-secondary-main/[3%] bg-white">
    <div class="container">
        <nav class="flex items-center justify-between p-6 laptop:px-8 " aria-label="Global">
            ...
            <div class="hidden laptop:flex laptop:gap-x-12">
                <a href="#" class="text-sm font-semibold leading-6 flex gap-4 items-center text-gray-900">
                    <span>
                        <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6" fill="none"
                ...
                <a href="#" class="text-sm font-semibold leading-6 flex gap-4 items-center text-gray-900">
                    <span>
                        <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6 dark:[&>path]:fill-gray-50"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Loqui</span>
                        <img class="h-8 w-auto" src={{ URL::asset('images/logo.svg') }} alt="loqui">
                    </a>
