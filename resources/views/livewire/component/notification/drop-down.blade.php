<div x-data="{ open: false }" class="relative">
    ...
    <div x-show="open" @click.outside="open = false" x-transition
        class="absolute top-10 w-full min-w-80 bg-white dark:bg-black rounded-md shadow-lg  p-4">
        ...
        <div class="flex flex-row items-center justify-center pt-4 gap-2">
            <a href="{{ route('notifications') }}"
                class="text-md font-medium leading-none text-brand-dark dark:text-white">View all notifications</a>
        </div>
    </div>
</div>
