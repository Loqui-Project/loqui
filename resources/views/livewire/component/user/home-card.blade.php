<div class="relative">
    <div
        class="sticky top-[90px] w-full z-[2] p-10 shadow-surface-glass max-laptop:py-4 backdrop-blur will-change-transform [@supports(backdrop-filter:blur(15px))]:bg-secondary-main/[3%] shadow-sm rounded-md bg-white/30 dark:bg-brand-dark/30">
        <div class="flex flex-col justify-start items-start gap-6">
            ...
            <div class="flex flex-row items-center justify-between gap-4 w-full">
                ...
                <button aria-label="Show Following users" class="flex flex-col gap-2 items-center justify-center"
                ...
                <button aria-label="Show Followers users" class="flex flex-col gap-2 items-center justify-center"
