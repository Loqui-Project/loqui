        ...
        <div class="flex flex-col items-start justify-start w-full gap-4">
            ...
            <div class="flex items-center gap-4 flex-row w-full  border-b pb-4">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <div>
                        <a href="{{ route('profile.user', ['username' => $message->sender->username]) }}" class="text-white text-sm italic">{{ '@' . $message->sender->username }}</a>
                    </div>
                    @endif
                </div>
            </div>
