        ...
        <div class="max-w-xl mx-auto max-laptop:max-w-full">
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <form class="space-y-6" wire:submit="signIn">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    <a wire:navigate href="{{ route('password.forget') }}" class="font-semibold transition-all duration-300 text-brand-dark hover:text-brand-main">Forgot
                                        password?</a>
                                </div>
                            </div>
                            <div class="mt-2">
                ...
                <div class="w-full flex items-center justify-center mt-4 bg-brand-dark py-2 rounded-md">
                    <a wire:navigate href="{{ route('auth.facebook.login') }}" class="text-white font-medium">login via facebook</a>
                </div>
                <p class="mt-10 text-center text-sm text-gray-500">
                    Not a member?
                    <a wire:navigate href="/auth/sign-up" class="font-semibold leading-6 transition-all duration-300 text-brand-dark hover:text-brand-main">
                        Sign up now
                    </a>
                </p>
            </div>
