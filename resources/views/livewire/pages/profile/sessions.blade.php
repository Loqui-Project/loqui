                        ...
                        <div class="flex flex-row items-center gap-4 w-full">
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div>
                                    ...
                                    @else
                                    <p class="text-white text-opacity-50">Last Active: {{$session["last_activity"]}}</p>
                                    @endif
                                </div>
                                <div>
