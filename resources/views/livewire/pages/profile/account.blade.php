    ...
    <div class="max-w-lg mx-auto py-4">
        <form wire:submit="updateProfile">
                            ...
                            <div class="mt-6 space-y-6">
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
                                        <input id="replay" name="replay" type="checkbox" disabled class="h-4 w-4 rounded border-gray-300 text-brand-dark focus:ring-brand-dark">
                                    </div>
                                    <div class="text-sm leading-6">
                                        <label for="replay" class="font-medium text-gray-900 dark:text-white">Replays</label>
                                ...
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
                                        <input id="candidates" name="candidates" type="checkbox" disabled class="h-4 w-4 rounded border-gray-300 text-brand-dark focus:ring-brand-dark">
                                    </div>
                                    <div class="text-sm leading-6">
                                        <label for="candidates" class="font-medium text-gray-900 dark:text-white">Message</label>
                                        <p class="text-gray-500">Get notified when a user send a message to you.</p>
                                    </div>
                                </div>
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
                                        <input id="offers" name="offers" type="checkbox" disabled class="h-4 w-4 rounded border-gray-300 text-brand-dark focus:ring-brand-dark">
                                    </div>
                                    <div class="text-sm leading-6">
                                        <label for="offers" class="font-medium text-gray-900 dark:text-white">Likes</label>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button aria-label="Reset values" type="button" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Cancel</button>
                <button aria-label="Save" type="submit" class="rounded-md bg-brand-dark px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-dark">Save</button>
            </div>
        </form>
    </div>
</div>