            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 dark:border-white pb-12">
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-white">
                        {{ __('This information will be displayed publicly so be careful what you share.') }}</p>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 space-y-10">
                        <fieldset>
                            ...
                            <div class="mt-6 space-y-6">
                                ...
                                <div class="relative flex gap-x-3">
                                    ...
                                    <div class="text-sm leading-6">
                                        <label for="message"
                                            class="font-medium text-gray-900 dark:text-white">{{ __('Message') }}</label>
                                        <p class="text-gray-500">
                                            {{ __('Get notified when a user send a message to you.') }}</p>
                                    </div>
                                </div>
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
                                    ...
                                    <div class="text-sm leading-6">
                                        ...
                                        <p class="text-gray-500">
                                            {{ __('Get notified when a user add like to your replay.') }}</p>
                                    </div>
                                </div>
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
                                    ...
                                    <div class="text-sm leading-6">
                                        <label for="follow"
                                            class="font-medium text-gray-900 dark:text-white">{{ __('Follow') }}</label>
                        ...
                        <fieldset>
                            <legend class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">
                                {{ __('By Browser Notification') }}</legend>
                            <div class="mt-6 space-y-6">
                                <div class="relative flex gap-x-3">
                                    <div class="flex h-6 items-center">
