                ...
                <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" wire:submit="resetPassword">
                        <div>
                            ...
                            <div class="mt-2">
                                <input wire:model="password" type="password" autocomplete="password"
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block text-sm font-medium leading-6 text-gray-900">Re-type Password</label>
                            <div class="mt-2">
                                <input wire:model="password_confirmation" type="password" autocomplete="password"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-brand-dark sm:text-sm sm:leading-6">
                                <div class="text-danger">
