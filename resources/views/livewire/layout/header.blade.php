        ...
        <nav class="flex items-center justify-between laptop:px-8 flex-wrap" aria-label="Main navbar">
            ...
            <div class="flex laptop:flex-1 laptop:justify-end">
                <div class="max-laptop:flex hidden">
                    <button type="button" @click="openMenu = !openMenu" aria-label="Open mobile menu" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
                        <span class="sr-only">Open main menu</span>
                        <svg x-show="openMenu" class="h-6 w-6 dark:[&>path]:stroke-white" viewBox="0 0 24 24" stroke-width="1.5" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                        <svg x-show="openMenu == false" class="h-6 w-6 dark:[&>path]:stroke-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <div class="hidden laptop:flex laptop:gap-x-6 p-4">
                <a href={{ route('auth.sign-in') }} class="text-sm font-semibold leading-6 flex gap-4 items-center text-gray-900 dark:text-white">
                    <span>
                        {{ __('Sign in') }}
                    </span>
                </a>
                <a href={{ route('auth.sign-out') }} class="text-sm bg-brand-dark text-white px-8 py-2 rounded-md hover:bg-brand-dark/90 transition-all duration-300 font-semibold leading-6 flex gap-4 items-center  ">
                    <span>
                        {{ __('Sign up') }}
                    </span>
                </a>
        ...
        <div class="laptop:hidden" role="dialog" aria-modal="true">
            <div class="mt-6 flow-root" x-show="openMenu" @click.outside="openMenu = false" x-transition>
                <div class="flex flex-col gap-4">
                    <a href={{ route('home') }} class="text-sm font-semibold transition-all duration-300 hover:pb-2  hover:border-b hover:border-white  leading-6 flex gap-4 items-center text-gray-900 dark:text-white">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6 dark:fill-white" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0295 2.58983C11.5893 2.11485 12.4107 2.11485 12.9705 2.58983L20.4705 8.95347C20.8064 9.23847 21 9.65672 21 10.0972V19.5C21 20.3284 20.3284 21 19.5 21H13.75C13.3358 21 13 20.6642 13 20.25V14H11V20.25C11 20.6642 10.6642 21 10.25 21H4.5C3.67157 21 3 20.3284 3 19.5V10.0972C3 9.65672 3.19364 9.23847 3.52953 8.95347L11.0295 2.58983ZM12 3.7336L4.5 10.0972L4.5 19.5H9.5V13.25C9.5 12.8358 9.83579 12.5 10.25 12.5H13.75C14.1642 12.5 14.5 12.8358 14.5 13.25V19.5H19.5V10.0972L12 3.7336Z" />
                            </svg>
                    ...
                    <a href={{ route('search') }} class="text-sm font-semibold leading-6 transition-all duration-300 hover:pb-2  hover:border-b hover:border-white flex gap-4 items-center text-gray-900 dark:text-white">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6 fill-black dark:fill-white" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.25 2C5.69365 2 2 5.69365 2 10.25C2 14.8063 5.69365 18.5 10.25 18.5C12.2581 18.5 14.0987 17.7825 15.5293 16.59L21.2197 22.2803C21.5126 22.5732 21.9874 22.5732 22.2803 22.2803C22.5732 21.9874 22.5732 21.5126 22.2803 21.2197L16.59 15.5293C17.7825 14.0987 18.5 12.2581 18.5 10.25C18.5 5.69365 14.8063 2 10.25 2ZM3.5 10.25C3.5 6.52208 6.52208 3.5 10.25 3.5C13.9779 3.5 17 6.52208 17 10.25C17 13.9779 13.9779 17 10.25 17C6.52208 17 3.5 13.9779 3.5 10.25Z" />
                            </svg>
                    ...
                    <a href={{ route('inbox') }} class="text-sm font-semibold leading-6 transition-all duration-300 hover:pb-2  hover:border-b hover:border-white flex gap-4 items-center text-gray-900 dark:text-white">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6 fill-black dark:fill-white" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.80111 3.5709C5.07434 2.92198 5.70987 2.5 6.41397 2.5H17.5877C18.2903 2.5 18.9248 2.9202 19.199 3.56709L22.9405 12.3948C22.9798 12.4874 23 12.5869 23 12.6875V20.25C23 21.2165 22.2165 22 21.25 22H2.75C1.7835 22 1 21.2165 1 20.25V12.75C1 12.65 1.01998 12.5511 1.05877 12.459L4.80111 3.5709ZM6.41397 4C6.31339 4 6.2226 4.06028 6.18357 4.15299L2.87956 12H8C8.26675 12 8.51343 12.1417 8.64783 12.3721L10.1808 15H13.8192L15.3522 12.3721C15.4852 12.144 15.7284 12.0027 15.9925 12L21.1223 11.9487L17.8179 4.15244C17.7787 4.06003 17.6881 4 17.5877 4H6.41397ZM21.5 13.445L16.4333 13.4957L14.8978 16.1279C14.7634 16.3583 14.5168 16.5 14.25 16.5H9.75C9.48325 16.5 9.23657 16.3583 9.10217 16.1279L7.56922 13.5H2.5V20.25C2.5 20.3881 2.61193 20.5 2.75 20.5H21.25C21.3881 20.5 21.5 20.3881 21.5 20.25V13.445Z" />
                            </svg>
                    ...
                    <a wire:navigate href="{{ route('notifications') }}" class="text-sm font-semibold leading-6 transition-all duration-300 hover:pb-2  hover:border-b hover:border-white flex gap-4 items-center text-gray-900 dark:text-white">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" class="w-6 h-6 fill-black dark:fill-white" xmlns="http://www.w3.org/2000/svg">
