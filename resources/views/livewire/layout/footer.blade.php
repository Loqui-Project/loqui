...
<div
    class=" shadow-surface-glass max-laptop:py-4 backdrop-blur will-change-transform [@supports(backdrop-filter:blur(15px))]:bg-secondary-main/[3%] shadow-sm rounded-md bg-white/30 dark:bg-brand-dark/30">
            ...
            <div class="flex flex-col items-center w-full my-20">
                ...
                <div class="flex items-center">
                    <p class="text-base dark:text-white font-normal leading-7 text-center text-grey-700">
                        {{ Carbon::now()->format("Y-m-d") }} {{ env('APP_NAME') }}. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
